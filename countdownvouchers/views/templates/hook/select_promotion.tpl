...
{if isset($list_promo) AND ($list_promo eq 1) AND $promotionlist}
    <section class="page-product-box">
            ...
            <table class="table-responsive-row">
                <thead>
                    <tr>
                ...
                <tbody>
                    {foreach from=$promotionlist item=list_promo}
                        <tr>
                            <td><b>{if $list_promo.reduction_type == 'percentage'}{$list_promo.reduction|escape:'htmlall':'UTF-8'}{l s='%' mod='countdownvouchers'}{else}{convertPrice price=$list_promo.reduction|escape:'htmlall':'UTF-8'}{/if}</b></td>
